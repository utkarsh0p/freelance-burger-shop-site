...
export const menu = {
  burgers: [
    ...
    { name: "Delight Burger", prices: [49, 59] },
    { name: "Makhani Burger", prices: [69, 89] },
    { name: "Crunchy Veg Burger", prices: [79, 99] },
    { name: "Crunchy Veg Double Patty Burger", prices: [89, 119] },
    { name: "Crunchy Cheese Burger", prices: [99, 129] },
    { name: "Crunchy Tandoori Burger", prices: [119, 149] },
    { name: "Royal Paneer Burger", prices: [129, 159] },
    { name: "Premium Veggie Burger", prices: [139, 169] },
    { name: "King Fusion Burger", prices: [149, 179] },
  ],

  wraps: [
    { name: "Veg Wrap", prices: [79, 99] },
    { name: "Corn Wrap", prices: [99, 139] },
    { name: "Paneer Wrap", prices: [149, 179] },
  ],

  sandwiches: [
    { name: "Veg Sandwich", prices: [79, 99] },
    { name: "Corn Sandwich", prices: [99, 119] },
    { name: "Cheese Corn Sandwich", prices: [129, 149] },
    { name: "Tandoori Paneer Sandwich", prices: [149, 189] },
  ],

  fries: [
    { name: "French Fries", prices: [59, 69] },
    { name: "Crinkle Fries", prices: [79, 99] },
    { name: "Perry Perry Fries", prices: [99, 119] },
    { name: "Saucy Fries", prices: [129, 149] },
  ],

  sides: [
    { name: "Veggie Strips", prices: [99] },
    { name: "Cheese Corn Nuggets", prices: [99] },
    { name: "Potato Cheese Shots", prices: [99] },
    { name: "Chilly Garlic Shots", prices: [99] },
  ],

  shakes: [
    { name: "Vanilla Shake", prices: [99, 119] },
    { name: "Mango Shake", prices: [119, 139] },
    { name: "Chocolate Shake", prices: [129, 159] },
    { name: "Oreo Shake", prices: [139, 169] },
    { name: "Burbourn Shake", prices: [149, 179] },
  ],

  coldCoffee: [
    { name: "Classic Cold Coffee", prices: [99, 119] },
    { name: "Hazelnut Cold Coffee", prices: [119, 139] },
    { name: "Vanilla Cold Coffee", prices: [129, 159] },
    { name: "Mocha Cold Coffee", prices: [139, 169] },
  ],

  softies: [
    { name: "Vanilla Softie", prices: [39] },
    { name: "Mango Softie", prices: [49] },
    { name: "Chocolate Softie", prices: [59] },
  ],

  others: [
    { name: "Cold Drinks", prices: ["MRP"] },
